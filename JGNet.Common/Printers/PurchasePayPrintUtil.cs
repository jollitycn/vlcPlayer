...
{
    public class PurchasePayPrintUtil
    {

        private SupplierAccountRecord suplierRecord;
        ...
        public void RefundCostume_PrintPage2(object sender, PrintPageEventArgs e)
        {
          ...
          //  }
            ...
            int lenSupStr = System.Text.Encoding.Default.GetBytes(suplierRecord.SupplierName).Length;
            ...
            for (int i = 0; i < spacelen/2 - lenSupStr; i++)
            {
             ...
             line = "_"+suplierRecord.SupplierName+ spaceStr + "_"; 

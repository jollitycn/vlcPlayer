...
{
    /// <summary>
    /// 支持二维表头（列合并、列合并）的DataGridView。
    /// （1）行合并：DataMergedView.MergeColumnNames.Add()方法。
    /// （2）列合并：DataMergedView.AddSpanHeader()方法。
    /// https://www.cnblogs.com/victor-huang/p/8608009.html
    /// </summary>
    public partial class DataMergedView : DataGridView
    {
        #region 构造函数
        ...
        #region  override OnCellPainting
        ...
        #region MergeColumnHeaderBackColor

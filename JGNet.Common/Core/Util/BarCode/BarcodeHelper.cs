...
namespace JGNet.Common.Core.Util.BarCode
{
        /// <summary>
        /// 描述：条形码和二维码帮助类
        /// 时间：2018-02-18
        ...
        public class BarcodeHelper
        {
            ...
            /// <returns></returns>
            public static Bitmap Generate2D(BarcodeFormat format,string text, int width, int height)
            {
        ...
        /// <param name="height">高度</param>
        /// <returns></returns>
        public static Bitmap Generate(BarcodeFormat format, string text, int width, int height)
        {
            BarcodeWriter writer = new BarcodeWriter();

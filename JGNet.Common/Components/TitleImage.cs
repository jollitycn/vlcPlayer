...
{
    public partial class TitleImage : UserControl
    {
        ...
        public CJBasic.Action<TitleImage, EventArgs> OnSelected;
        public CJBasic.Action<TitleImage, EventArgs> OnRemoved;
        ...
        public TitleImage(String title, Image image, EventHandler MenuItem_Click)
        {
            InitializeComponent();

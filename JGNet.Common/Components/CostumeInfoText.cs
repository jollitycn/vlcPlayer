...
{
    public partial class CostumeInfoText :TextBox
    {

        /// <summary>
        /// 款号被选中时触发
        /// </summary>
        public event CJBasic.Action<Costume, bool> CostumeSelected;
        ...
        {
            if (this.Text.Contains("costumeInfoText") || this.SkinTxt.Text.Contains("costumeInfoText")) { this.Text = ""; this.SkinTxt.Text = ""; return; }

...
{
	[Serializable]
	public partial class DayReport : IEntity<System.Int32>
	{
	    #region Force Static Check
		public const string TableName = "DayReport" ;
		...
		/// <summary>
		/// ReportDate 哪一天的日报，固定8位数字，如20180302
		/// </summary>
		...
		/// <summary>
		/// AllocateInCount 当日调拨入库数量（从其它店铺或总仓）
		/// </summary>
		...
		/// <summary>
		/// PurchaseInCount 当日采购进货入库数量（从供应商）
		/// </summary>
		...
		/// <summary>
		/// AllocateOutCount 当日调拨数量（给其它店铺或总仓）
		/// </summary>

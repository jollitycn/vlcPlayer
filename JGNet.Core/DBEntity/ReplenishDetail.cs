...
{
	[Serializable]
	public partial class ReplenishDetail : IEntity<System.Int32>
	{
	    #region Force Static Check
		public const string TableName = "ReplenishDetail" ;
		public const string _AutoID = "AutoID" ;
		public const string _ReplenishOrderID = "ReplenishOrderID" ;
		...
		#region ReplenishOrderID
		private System.String m_ReplenishOrderID = "" ; 
		/// <summary>
		/// ReplenishOrderID 补货单号
		/// </summary>
		public System.String ReplenishOrderID
		{
			get
			{
				return this.m_ReplenishOrderID ;
			}
			set
			{
				this.m_ReplenishOrderID = value ;
			}
		}
		#endregion

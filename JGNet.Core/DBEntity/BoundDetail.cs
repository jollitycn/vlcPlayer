...
{
	[Serializable]
	public partial class BoundDetail : IEntity<System.Int32>
	{
	    #region Force Static Check
		public const string TableName = "BoundDetail" ;
		public const string _AutoID = "AutoID" ;
		public const string _BoundOrderID = "BoundOrderID" ;
		...
		#region BoundOrderID
		private System.String m_BoundOrderID = "" ; 
		/// <summary>
		/// BoundOrderID 出入库单号
		/// </summary>
		public System.String BoundOrderID
		{
			get
			{
				return this.m_BoundOrderID ;
			}
			set
			{
				this.m_BoundOrderID = value ;
			}
		}
		#endregion

...
{
	[Serializable]
	public partial class GuideMonthAchievement : IEntity<System.Int32>
	{
	    #region Force Static Check
		public const string TableName = "GuideMonthAchievement" ;
		...
		public const string _ContributionVipCount = "ContributionVipCount" ;
		public const string _NewVipCount = "NewVipCount" ;
	    #endregion
		...
		/// <summary>
		/// SalesTotalMoneyVip 当前导购销售的VIP总金额（扣除退货）
		/// </summary>
		...
		#region ContributionVipCount
		private System.Int32 m_ContributionVipCount = 0 ; 
		/// <summary>
		/// ContributionVipCount 当前导购销售的会员数量
		/// </summary>
		public System.Int32 ContributionVipCount
		{
			get
			{
				return this.m_ContributionVipCount ;
			}
			set
			{
				this.m_ContributionVipCount = value ;
			}
		}
		#endregion
	
		#region NewVipCount
		private System.Int32 m_NewVipCount = 0 ; 
		/// <summary>
		/// NewVipCount 当前导购下新增会员的数量
		/// </summary>
		public System.Int32 NewVipCount
		{
			get
			{
				return this.m_NewVipCount ;
			}
			set
			{
				this.m_NewVipCount = value ;
			}
		}
		#endregion
	    #endregion

namespace CJBasic.Helpers
{
    ...
    public static class FileHelper
    {
        ...
        public static void EnsureDirectoryExist(string filePath)
        {
            ...
            string path = filePath.Substring(0, num + 1);
        ...
        public static string GetExtendName(string fileNameOrPath)
        {
            return fileNameOrPath.Substring(fileNameOrPath.LastIndexOf('.')).ToLower();
        }
        ...
        public static string[] GetFilesToOpen(string title)
        {
        ...
        public static void ReadFileData(Stream fs, byte[] buff, int count, int offset)
        {
            int num2;
